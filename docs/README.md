...
Use these guides as the main navigation for the project:

- [Build And Workflow](./build-and-workflow.md) for commands, toolchain expectations, and script entry points.
- [Kernel Architecture](./kernel-architecture.md) for a subsystem-level walkthrough of the current kernel design and hardware abstraction layout.
